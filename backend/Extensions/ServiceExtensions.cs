...
public static class ServiceExtensions
{
    public static IServiceCollection ExtendServices( this IServiceCollection services, IConfiguration config )
    {
        ...
        {
            options.SwaggerDoc("v1", new OpenApiInfo { Title = "Adashop API", Version = "v1" });
        ...
        services.AddHttpClient<ISpecsService, SpecsService>();
        services.AddScoped<ISpecsService, SpecsService>();
